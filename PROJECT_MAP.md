...
- [x] Implement dark glassmorphism theme (`backdrop-filter: blur`, subtle translucent borders).
- [x] Add neon glowing borders matching active team colors.
- [x] Integrate modern typography using the Cairo Google Font (`Cairo:wght@400;600;700;900`).
- [x] Clean up and polish mobile viewport responsive alignments.

### 📊 Dashboard Match Indicators (Style of wcup2026.org)
- [x] **AI Prediction Score**: Show predicted score (e.g. `2-1` or `1-0`) on match cards.
- [x] **FIFA Team Rank**: Show FIFA ranking (e.g., `#2` or `#8`) for each team on match cards.
